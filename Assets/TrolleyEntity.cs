...
public class TrolleyEntity : MonoBehaviour
{
    ...
    public float TROLLEY_VELOCITY = 0.5f;
    ...
    void Start()
    {
        ...
        joint1.connectedAnchor = new Vector3(0, 0.05f, 0.01f);
       ...
       // joint2AngXLimit.damper = 5f;
        ...
        joint2.connectedAnchor = new Vector3(0, -0.05f, 0.01f);
